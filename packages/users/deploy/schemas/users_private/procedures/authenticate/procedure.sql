-- Deploy: schemas/users_private/procedures/authenticate/procedure to pg
...
CREATE FUNCTION "users_private".authenticate (token_str text)
    RETURNS SETOF "users_private".api_tokens
AS $$
SELECT
    tkn.*
FROM
